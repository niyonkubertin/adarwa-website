        ...
        <div className="max-w-7xl mx-auto px-4 py-2 flex flex-wrap justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="hover:text-[#D4A25A] transition-colors text-xs font-medium" aria-label="Facebook">
                FB
              </a>
              <a href="#" className="hover:text-[#D4A25A] transition-colors text-xs font-medium" aria-label="Instagram">
                IG
              </a>
          ...
          <div className="hidden lg:flex items-center gap-8">
            {navItems.slice(0, -1).map((item, index) => (
              ...
              >
                <Link
                  href={item.href}
                  className="relative font-medium text-gray-700 hover:text-[#8B5A2B] transition-colors after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-0.5 after:bg-[#D4A25A] after:transition-all after:duration-300 hover:after:w-full"
                >
                  {item.label}
                </Link>
              </motion.div>
            ...
            <div className="px-4 py-4 space-y-3">
              {navItems.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="block text-gray-700 hover:text-[#8B5A2B] transition-colors font-medium py-2"
